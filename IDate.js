(function (root, undefined) {
    ...
    var IDate = function (value) {
        ...
        if (value === undefined) {
             ...
             * IDate
             */
            this.attributes = this._clone(value.attributes);
            ...
            this.attributes = this._clone((new IDate(dateType)).getShifted(value).attributes);
    ...
    IDate.extend = function (attributes) {
        ...
        attributes = IDate.prototype._clone(attributes);

        for (prop in attributes) {
            if (attributes.hasOwnProperty(prop)) {
                ret.prototype[prop] = attributes[prop];
            }
        }
